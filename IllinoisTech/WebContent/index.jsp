...
<div id="main">
  <div class="shell">
    ...
    <div id="content">
      ...
      products = mysql.selectProducts("Baseball");
      %>
      <div id="container">
        <div class="tabbed">
          <!-- First Tab Content -->
            ...
            <div class="items">
              ...
              %>
                <li>
                  ...
                  <p> Product Name : <span><%= p.getProductName() %></span><br/>         
                  <p class="price">Wholesale Price: <strong><%= p.getPrce() %></strong></p>
                  <p> Discount : <span><%= p.getDiscount() %></span><br />
